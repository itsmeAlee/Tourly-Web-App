      ...
      <div className="relative z-10 text-center px-4 max-w-6xl w-full page-transition py-20">
        <div className="mb-8 inline-flex items-center gap-2 px-4 py-2 rounded-full border bg-accent/50">
          <span className="text-sm font-medium text-muted-foreground">
            Discover Pakistan's Northern Areas
          </span>
        </div>

        <h1 className="text-foreground text-3xl md:text-7xl mb-6 font-bold leading-tight tracking-tight">
          Plan Your Perfect
          <span className="block mt-2 lg:hidden text-primary">
            Mountain Escape
          </span>
          <br />
        ...
        <div className="relative w-full">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 800px 300px at center, oklch(0.71 0.15 239.15), transparent)",
            }}
          ></div>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 0 20px rgba(88, 86, 214, 0.3), 0 0 40px rgba(88, 86, 214, 0.15)",
              }}
            >
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-2 items-center">
          ...
          {["Skardu", "Hunza Valley", "Fairy Meadows", "Naran"].map((place) => (
            <button
              key={place}
              className="px-4 py-1.5 hover:bg-accent text-sm text-foreground rounded-full border transition-all"
            >
              {place}
            </button>
          ))}
